                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        <Link to="/" className="flex items-center gap-2 mb-4">
                            ...
                            <div>
                                <span className="text-xl font-display font-bold text-white">Jas&Mey</span>
                                <span className="block text-[10px] font-medium tracking-wider uppercase text-gray-400">
                                    Premium Ice Creams
                                </span>
                            </div>
                        </Link>
                        <p className="text-gray-400 text-sm leading-relaxed mb-6">
                            Crafting happiness one scoop at a time. Premium artisan ice creams made with love and the finest ingredients.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                { name: 'Cones', path: '/shop?category=Cones' },
                                { name: 'Tubs', path: '/shop?category=Tubs' },
                                { name: 'Family Packs', path: '/shop?category=Family Packs' },
                                { name: 'Premium', path: '/shop?category=Premium' },
                            ].map((link) => (
                                <li key={link.path}>
                                    <Link to={link.path} className="text-gray-400 hover:text-rose-400 text-sm transition-colors">
                                        {link.name}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 mb-6">
                            <li className="flex items-start gap-3 text-gray-400 text-sm">
                                ...
                                <span>123 Ice Cream Lane, Mumbai, MH 400001</span>
                            </li>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm">
                            © {new Date().getFullYear()} Jas&Mey. All rights reserved.
                        </p>
